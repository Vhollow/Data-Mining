...
#Fase hacia delante
  ...
  entrada = cat(1,M(i:19+i),anterioresOculta)';#Entrada a la primera capa con los valores de entrada y la salida de la oculta 
  #Capa entrada->oculta
  for j=1:10
